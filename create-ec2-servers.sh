...
##### Change these values ###
ZONE_ID="Z038365715L62IU2I65CQ"
DOMAIN="saraldevops.online" # this is the domain we have purchased and set it up in route 53
SG_NAME="allow-all" # this is security group name
#############################
